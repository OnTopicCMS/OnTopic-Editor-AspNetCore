...
namespace Ignia.Topics.Editor.Mvc.Components {
  ...
  public class TextAreaViewComponent: AttributeTypeViewComponentBase {
    ...
    public TextAreaViewComponent(ITopicRoutingService topicRoutingService) : base(topicRoutingService) { }
    ...
    public async Task<IViewComponentResult> InvokeAsync(
      ...
      \-----------------------------------------------------------------------------------------------------------------------*/
      var viewModel = new AttributeViewModel<TextAreaAttributeTopicViewModel>(attribute);
